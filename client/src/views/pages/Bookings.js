                    ...
                    <tbody>
                      {paginatedBookings.map((booking) => (
                        <tr key={booking._id} className="hover-border-primary cursor-pointer">
                          ...
                          <td>
                            {booking.room_details?.room_number || 'N/A'}
                            {booking.room_details?.category_name && <div className="text-muted text-small">{booking.room_details.category_name}</div>}
                          </td>
                  ...
                  <Row>
                    <Col md={4}>
                      <div className="mb-3">
                        ...
                        <div className="font-weight-bold">{selectedBooking.room_details?.room_number || 'N/A'}</div>
                      </div>
                    </Col>
                    <Col md={4}>
                      <div className="mb-3">
                        <small className="text-muted d-block">Category</small>
                        <div>{selectedBooking.room_details?.category_name}</div>
                      </div>
                    </Col>
                    <Col md={4}>
                      <div className="mb-3">
                        <small className="text-muted d-block">Floor</small>
                        <div>{selectedBooking.room_details?.floor}</div>
                      </div>
                    </Col>
                  </Row>
                </Card.Body>
                  ...
                  <div className="border rounded">
                      ...
                      <Row className="g-0">
                        <Col>
                          <small className="text-muted">
                            Room Charges ({selectedBooking.booking_summary?.nights} nights × {process.env.REACT_APP_CURRENCY} {selectedBooking.booking_summary?.price_per_night})
                          </small>
                        </Col>
                        <Col xs="auto" className="font-weight-bold">
                          {process.env.REACT_APP_CURRENCY} {selectedBooking.booking_summary?.subtotal}
                        </Col>
                      </Row>
                    </div>
                    ...
                    <div className="p-3 bg-light">
                      <Row className="g-0">
                        ...
                        <Col xs="auto">
                          <h6 className="mb-0 text-primary">{process.env.REACT_APP_CURRENCY} {selectedBooking.booking_summary?.total}</h6>
                        </Col>
                      </Row>
                    </div>
                  </div>
