          ...
          <Col sm="6" md="4" lg="2">
            <Card className="sh-11 hover-scale-up cursor-pointer">
              <Card.Body className="h-100 py-3 align-items-center">
                <Row className="g-0 h-100 align-items-center">
                  <Col xs="auto" className="pe-3">
                    <div className="bg-gradient-success sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
          ...
          <Col sm="6" md="4" lg="2">
            <Card className="sh-11 hover-scale-up cursor-pointer">
              <Card.Body className="h-100 py-3 align-items-center">
                <Row className="g-0 h-100 align-items-center">
                  <Col xs="auto" className="pe-3">
                    <div className="bg-gradient-primary sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
          ...
          <Col sm="6" md="4" lg="2">
            <Card className="sh-11 hover-scale-up cursor-pointer">
              <Card.Body className="h-100 py-3 align-items-center">
                <Row className="g-0 h-100 align-items-center">
                  <Col xs="auto" className="pe-3">
                    <div className="bg-gradient-warning sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
                      <CsLineIcons icon="users" className="text-white" />
                    </div>
                  </Col>
                  <Col>
                    <Row className="gx-2 d-flex align-content-center">
          ...
          <Col sm="6" md="4" lg="2">
            <Card className="sh-11 hover-scale-up cursor-pointer" as={NavLink} to="/dashboard/check-in-out">
              <Card.Body className="h-100 py-3 align-items-center">
                <Row className="g-0 h-100 align-items-center">
                  <Col xs="auto" className="pe-3">
                    <div className="bg-gradient-info sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
          ...
          <Col sm="6" md="4" lg="2">
            <Card className="sh-11 hover-scale-up cursor-pointer" as={NavLink} to="/dashboard/check-in-out">
              <Card.Body className="h-100 py-3 align-items-center">
                <Row className="g-0 h-100 align-items-center">
                  <Col xs="auto" className="pe-3">
                    <div className="bg-gradient-danger sh-5 sw-5 rounded-xl d-flex justify-content-center align-items-center">
                      <CsLineIcons icon="log-out" className="text-white" />
                    </div>
                  </Col>
                  <Col>
                    <Row className="gx-2 d-flex align-content-center">
                  ...
                  <Card.Body className="h-100 py-3">
                    <div className="d-flex flex-column justify-content-between h-100">
                      <div className="d-flex justify-content-between align-items-start">
                        ...
                        <CsLineIcons icon="bed" className="text-primary" size="17" />
                      </div>
                      <div className="cta-3 text-primary mt-2" style={{ fontSize: '12px' }}>
